class CocktailRecipesController < ApplicationController 
   ...
   def cocktail_recipe_params
     params.require(:cocktail_recipe).permit(:user_id, :category_name, :title, :directions, :description, :avatar, :avatar_delete, :add_ingredient, :remove_ingredient, :ingredients_attributes => [:id, :name]) 
   end 
